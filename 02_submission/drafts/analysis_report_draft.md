...
> 제출원고 v1.0, 2026-07-20. 공식 [서식3] 항목에 맞춰 데이터 선택·전처리·검토 과정과 AI 활용 기록을 시각자료와 함께 완성했다. 팀정보는 사실확인이 필요하므로 자리표시자로 남겼으며 제출 전 공식 HWP에 입력·확인한다.
...
<figure>
  <img src="../visuals/png/03_evidence_summary.png" alt="공사 교통정보, 국가표준 노드링크, 상가정보와 고정 분석결과 요약">
  <figcaption><strong>그림 1. 서비스 설계에 사용한 고정 데이터와 분석결과.</strong> 교통관측 2026.07.18 12:50–16:24, 상가 기준일 2026.03.31. 상가 수는 택배물량이 아닌 배송처 분포의 간접지표다.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption><strong>그림 2. AI 결과물의 사람 검토 절차.</strong> 공사자료 1건과 실제 연결 후보 3개를 적용한 개념 시안이다. AI는 후보 근거를 설명하고 담당자가 사용 여부를 확정한다.</figcaption>
</figure>
...
제안 화면은 공사정보 검토 대기목록, 공사정보·도로구간 검증, 배송위험 요약의 세 가지로 제한했다. 화면에는 공사기간·방향·통제차로, 사람이 선택한 방향별 도로구간, 공식 화면의 현재 교통상태·속도·갱신시각, 주변 250m 영업 중 상가 수와 출처를 표시한다. 검증되지 않은 AI 위험점수, 30분 예측, 권장 출차시각과 자동배차 기능은 표시하지 않는다.
