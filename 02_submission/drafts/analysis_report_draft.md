...
> 초안 v0.7, 2026-07-20. 제안서와 같은 용어를 사용하고, 분석을 처음 접하는 사람도 데이터 선택과 판단과정을 이해할 수 있도록 다시 작성했다. 기존 대시보드 시안은 폐기하고 표시할 UI·UX 요소와 데이터만 확정했다. 팀정보 반영 전이며 공식 HWP는 A4 3~5쪽 내외로 편집한다.
